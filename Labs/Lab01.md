...
5. Все вводимые аргументы должны контролироваться на корректностьи непротиворечивость (деление на 0 невозможно, квадратный корень из отрицательных чисел не является вещественным и пр.) Программа должна показывать сообщение об ошибке и запрашивать некорретное значение снова.
...
## Доп. требования
1. Вывод должен форматироваться до 3 знака после запятой (Пример: 3,111).
2. Должна осуществляться проверка строк на заведомо некорретные значения ("проверка на дурака"). Программа должна вывести сообщение о недопустимости значения и запросить его заново.
